...
for (i in 0:16) {
  ...
  #denom_preds <- long_sl_denom(dat, i, "death", "breast")

  # calculate the numerators
  num_preds <- long_sl_num(dat, i, "death", "breast")


  today <- str_remove_all(Sys.Date(), "-")

  #denom_file <- paste0("output/weights/breast_death/", today, "_denom_wv_", paste0(i, ".rds"))
  num_file <- paste0("output/weights/breast_death/", today, "_num_wv_", paste0(i, ".rds"))
  ...
  #filename1 <- paste0("output/r_objects/breast_death/", today, "_sl_fit_denom_wv_", paste0(i, ".rds"))
  filename2 <- paste0("output/r_objects/breast_death/", today, "_sl_fit_num_wv_", paste0(i, ".rds"))
