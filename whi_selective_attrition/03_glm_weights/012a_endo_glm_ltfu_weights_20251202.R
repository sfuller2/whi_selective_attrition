################################################################################
## Create censoring due ltfu weights (Endo)
## Sophia Fuller
## Date 12/02/2025
################################################################################
...
saveRDS(glm_models, here(paste0("output/glm_weights/endo_ltfu_weights_denom_", today, ".rds")))
...
saveRDS(glm_models, here(paste0("output/glm_weights/endo_ltfu_weights_num_", today, ".rds")))
